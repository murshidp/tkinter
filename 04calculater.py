...
button_sub = Button(root,text="-", padx=30,pady=20,command=button_substract)
button_div = Button(root,text="/", padx=30,pady=20,command=button_division)
button_mul = Button(root,text="*", padx=30,pady=20,command=button_multiplication)
